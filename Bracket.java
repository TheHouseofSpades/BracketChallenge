...
public class Bracket{
 ...
 public String playGame(Team a, Team b){
   for(int i=0;i<50;i++){
    pointsA = 0;
    pointsB = 0;
    if(a.wins - a.losses > b.wins - b.losses) pointsA += 30;
    else pointsB += 30;
    if(a.sosPythRank > b.sosPythRank) pointsA += 20;
    else pointsB += 20;
    if(a.adjORank + a.adjDRank < b.adjORank + b.adjDRank) pointsA += 20;
    else pointsB += 20;
    if(a.oppORank + a.oppDRank < b.oppORank + b.oppDRank) pointsA += 20;
    else pointsB += 20;
    for(int o;o<a.adjT;o++){
     pointsA += (int)(Math.random()*4);
    }
    for(int d;d<b.adjT;d++){
